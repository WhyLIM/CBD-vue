            ...
            <div class="advanced-filters">
                ...
                <div class="filters-grid">
                    ...
                    <div class="filter-group">
                        ...
                        <el-select :model-value="filters.category" placeholder="Select category" clearable multiple
                            collapse-tags @change="handleCategoryChange">
                    ...
                    <div class="filter-group">
                        ...
                        <el-select :model-value="filters.application" placeholder="Select application" clearable
                            multiple collapse-tags @change="handleApplicationChange">
                    ...
                    <div class="filter-group">
                        ...
                        <el-select :model-value="filters.location" placeholder="Select location" clearable multiple
                            collapse-tags @change="handleLocationChange">
                            <el-option v-for="location in availableLocations" :key="location" :label="location"
                                :value="location" />
                        </el-select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <el-select :model-value="filters.source" placeholder="Select sample source" clearable multiple
                            collapse-tags @change="handleSourceChange">
                            <el-option v-for="source in availableSources" :key="source" :label="source"
                                :value="source" />
                        </el-select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <div class="range-input">
                            <el-date-picker :model-value="filters.yearRange" type="yearrange" unlink-panels
                                range-separator="To" style="width: 100%" start-placeholder="Start Year"
                                end-placeholder="End Year"
                                :default-value="[new Date(minYear, 0, 1), new Date(maxYear, 11, 31)]"
                    ...
                    <div class="filter-group">
                        ...
                        <el-select :model-value="filters.region" placeholder="Select research region" clearable multiple
                            ...
                            <el-option v-for="region in availableRegions" :key="region" :label="region"
                                :value="region" />
                        </el-select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <el-select :model-value="filters.stage" placeholder="Select disease stage" clearable multiple
                            collapse-tags @change="handleStageChange">
...
const emit = defineEmits(['filterChange', 'applyPreset', 'clearFilters', 'savePreset'])

const yearMarks = computed(() => ({
    [props.minYear]: props.minYear.toString(),
    [props.maxYear]: props.maxYear.toString()
}))
