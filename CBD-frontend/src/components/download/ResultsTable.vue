    ...
    <div class="preview-section">
      ...
      <div class="table-container">
        <el-table :data="previewData" class="preview-table" v-loading="loading" max-height="400" stripe>
          <el-table-column prop="Biomarker" label="Biomarker" min-width="120" fixed="left" show-overflow-tooltip />
          ...
          <el-table-column prop="First_Author" label="First Author" min-width="120" show-overflow-tooltip />
          <el-table-column prop="Journal" label="Journal" min-width="120" show-overflow-tooltip />
          <el-table-column prop="Year" label="Year" min-width="80" show-overflow-tooltip />
